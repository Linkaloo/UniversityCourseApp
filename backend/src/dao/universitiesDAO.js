...
export default class UniversitiesDAO {
  static async injectDB(conn) {
    ...
    try {
      ...
      console.error(
        `Unable to establish a collenction handle in restaurantsDAO: ${err}`,
      );
    }
  }
  ...
  static async getUniversities({
    ...
    try {
      ...
      console.error(
        `Unable to conver cursor to array or problem counting documents: ${err}`,
      );
      return { universityList: [], totalNumUniversities: 0 };
    }
  }
